...
boolean result1;
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/java12.png"))); // NOI18N
        ...
        jButton1.setBackground(new java.awt.Color(132, 70, 30));
        jButton1.setFont(new java.awt.Font("Franklin Gothic Demi", 1, 14)); // NOI18N
        jButton1.setForeground(new java.awt.Color(227, 167, 121));
    ...
    String upper = master.changeToUpper(password1);

            if(username.getText().isEmpty() && password.getText().isEmpty())
               {  
         JOptionPane.showMessageDialog(rootPane,"the form con not be empty");
               }
            else if(!(password.getText().equals(upper))){
