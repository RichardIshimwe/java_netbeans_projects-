...
public class NewJFrame1 extends javax.swing.JFrame {
    ...
    private void buttonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonActionPerformed
        ...
        String secondname = ln.getText();
        String data[]={firstname,secondname};
    ...
    private void reviewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_reviewActionPerformed
        // TODO add your handling code here:
        TableModel table2 = table.getModel();
        int index[] = table.getSelectedRows();
        Object[] row = new Object[2];
        label1.setText(table2.getValueAt(index[0], 0).toString());
        label2.setText(table2.getValueAt(index[0], 1).toString());
